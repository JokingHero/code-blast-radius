...
export const RecipeBuilder = () => {
  ...
  const handleOuterDrop = async (e: DragEvent) => {
    ...
    // Check for External OS Drag
      ...
      // NOTE: Handled by Tauri OS drag drop separately usually, but good for web fallback
    }
            ...
            <div class="fixed inset-0 z-[100] bg-matrix-bg/90 backdrop-blur-sm flex items-center justify-center p-4 animate-[fadeIn_0.1s_ease-out]">
                <div class="w-full max-w-lg border border-matrix-primary p-1 bg-matrix-panel shadow-glow">
                    ...
                    <div class="flex items-center justify-between bg-matrix-primary/20 p-2 mb-2">
                        ...
                        <button onClick={() => setShowPatternModal(false)} class="text-matrix-primary hover:text-matrix-error font-bold px-2">
                            [x]
                        </button>
                    </div>
                    ...
                    <div class="p-2 space-y-4">
                        ...
                        <div class="text-xs font-mono text-matrix-primary/80 border border-matrix-border/50 bg-black/40">
                            ...
                            {/* Footer Note for Negation */}
                            <div class="border-t border-matrix-border/30 p-2 bg-matrix-error/5 text-center text-matrix-error/90 italic">
                                To <strong>Exclude</strong> files, use the <span class="border border-matrix-error/40 px-1 not-italic font-bold text-[10px] mx-1">EXCLUDE</span> button below.
                            </div>
                        </div>
